  ...
  return (
    <div className="flex min-h-screen bg-[#0a0a0a] text-white">
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 p-2 bg-[#1a1a1a] rounded-lg border border-white/10"
      >
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:static inset-y-0 left-0 z-40 w-64 bg-[#111] border-r border-white/10 transform ${
      ...
      {/* Main Content */}
      <main className="flex-1 p-4 md:p-8 md:ml-0 overflow-y-auto">
